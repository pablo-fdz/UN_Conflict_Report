...
config_files_path = os.path.join(parent_dir, 'config_files')  # Find path to config_files folder
...
with neo4j.GraphDatabase.driver(neo4j_uri, auth=(neo4j_username, neo4j_password)) as driver:
    ...
    try:
        asyncio.run(resolver.run())  # Use asyncio.run() to execute the coroutine
